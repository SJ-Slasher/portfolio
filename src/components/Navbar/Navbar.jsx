    ...
    >
      <div className="max-w-screen-xl mx-auto flex justify-between items-center py-4 px-4 md:px-10 lg:px-16 text-white">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          Suprim<span className="text-[#8245ec]">/</span>Joshi
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/SJ-Slasher"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/suprim-joshi-682a2a237/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
          ...
          <a
            href="https://instagram.com/hande_na_galama"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
